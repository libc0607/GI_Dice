...
#define BLE_UART_SERVICE_UUID_HI 0xff
#define BLE_UART_SERVICE_UUID_LO 0xf0
#define BLE_UART_CHAR_TX_UUID_HI 0xff
#define BLE_UART_CHAR_TX_UUID_LO 0xf1
#define BLE_UART_CHAR_RX_UUID_HI 0xff
#define BLE_UART_CHAR_RX_UUID_LO 0xf2
